...
Roteiro *roteiro_construct()
{
    ...
    rot = (Roteiro *)calloc(1, sizeof(Roteiro));
...
{
    r->qtdIns++;
    r->midias = (Midia **)realloc(r->midias, r->qtdIns * sizeof(Midia *));
    r->midias[r->qtdIns - 1] = midia_construct(dado, print_fn, free_fn);
}
